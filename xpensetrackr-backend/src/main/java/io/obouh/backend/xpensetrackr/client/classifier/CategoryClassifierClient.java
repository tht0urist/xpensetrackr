package io.obouh.backend.xpensetrackr.client.classifier;

import io.obouh.backend.xpensetrackr.client.classifier.request.Transaction;
import io.obouh.backend.xpensetrackr.client.classifier.request.TransactionRequest;
import io.obouh.backend.xpensetrackr.client.classifier.response.BatchResponse;
